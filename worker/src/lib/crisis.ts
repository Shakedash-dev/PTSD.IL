...
const PHRASES: string[] = [
  ...
  // Hebrew — "want to die" family (mirrors the English "want to die"; was missing)
  "רוצה למות", "רוצה לגמור עם הכל", "לגמור עם החיים", "אין טעם לחיות",
  "עדיף למות", "מוטב שלא אהיה כאן",
  // Arabic
