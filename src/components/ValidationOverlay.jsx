      ...
      {expanded && isValidationMode && (
        <div className="bg-card border border-border rounded-xl shadow-xl p-4 w-52 text-sm">
          ...
          <div className="flex gap-2 mt-3">
            <button
              onClick={exportState}
              className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 bg-muted text-foreground rounded-lg text-xs hover:bg-border transition-colors"
        ...
        <button
          ...
          className={`flex items-center gap-2 px-3 py-2 rounded-full shadow-lg text-sm font-medium transition-all ${
            isValidationMode
              ...
              : 'bg-foreground text-background hover:bg-foreground/90 opacity-70 hover:opacity-100'
          }`}
        >
