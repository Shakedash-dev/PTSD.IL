export const RIGHTS_FAQS = {
  he: {
    security_forces: [
      ...
      {
        q: 'אפשר לקבל טיפול רפואי עוד לפני שהתקבלה ההכרה?',
        a: `<p>כן. לאחר הגשת בקשה להכרה בפגיעה נפשית, ניתן לקבל אישור לטיפול רפואי ונפשי מאגף השיקום כבר במהלך בירור הבקשה - עוד לפני שהתקבלה החלטה סופית. את היקף הטיפול קובע הרופא המחוזי, ויש לבקש זאת מקצין/ת התגמולים המטפל/ת בתיק.</p>`,
        steps: '',
        links: [{ label: 'טיפול רפואי בזמן תהליך ההכרה בנכות', url: 'https://shikum.mod.gov.il/recognition/request/medical-care' }],
      },
      {
    ...
    general: [
      ...
      },
      {
        ...
        a: `<p>מי שנקבעה לו נכות רפואית משוקללת של <strong>20% לפחות</strong> לצמיתות, זכאי לבדוק זכאות לשיקום מקצועי מביטוח לאומי - גם אם אינו מקבל קצבת נכות. השירות כולל אבחון תעסוקתי, ייעוץ מקצועי, מימון לימודים או הכשרה, וקצבת שיקום בזמן הלימודים.</p>`,
        steps: '',
        links: [{ label: 'ביטוח לאומי - שיקום מקצועי ונכות נפשית', url: 'https://www.btl.gov.il/ZcuyotAsdience/MitmoddiNefesh/Pages/NecotNafsitShikomMikzoei.aspx' }],
      },
      {
  ...
  ar: {
    security_forces: [
      ...
      {
        q: 'هل يمكنني الحصول على علاج طبي قبل صدور الاعتراف؟',
        a: `<p>نعم. بعد تقديم طلب الاعتراف بإصابة نفسية، يمكن الحصول على موافقة للعلاج الطبي والنفسي من إدارة إعادة التأهيل أثناء فحص الطلب نفسه - قبل صدور القرار النهائي. الطبيب المسؤول عن المنطقة هو من يحدد نطاق العلاج، ويجب طلب ذلك من ضابط التعويضات المسؤول عن الملف.</p>`,
        steps: '',
        links: [{ label: 'العلاج الطبي أثناء عملية الاعتراف بالعجز', url: 'https://shikum.mod.gov.il/recognition/request/medical-care' }],
      },
      {
    ...
    general: [
      ...
      },
      {
        ...
        a: `<p>من تقرر له عجز طبي مرجّح بنسبة <strong>20% على الأقل</strong> بشكل دائم، يحق له فحص الأهلية للتأهيل المهني من التأمين الوطني - حتى لو لم يكن يتلقى راتب عجز. تشمل الخدمة تقييماً مهنياً، استشارة مهنية، تمويل دراسة أو تدريب، وراتب تأهيل خلال فترة الدراسة.</p>`,
        steps: '',
        links: [{ label: 'التأمين الوطني - التأهيل المهني والعجز النفسي', url: 'https://www.btl.gov.il/ZcuyotAsdience/MitmoddiNefesh/Pages/NecotNafsitShikomMikzoei.aspx' }],
      },
      {
  ...
  en: {
    security_forces: [
      ...
      {
        q: 'Can I receive medical treatment even before recognition is granted?',
        ...
        steps: '',
        links: [{ label: 'Medical treatment during the disability recognition process', url: 'https://shikum.mod.gov.il/recognition/request/medical-care' }],
      },
      {
