...
export const STATIC_TOOLS = [
  ...
  },
  {
    ...
    iconBg: 'bg-clay/15',
    content_he: `<p>אפליקציה לתרגילי נשימה סרעפתית, פותחה על ידי גורמי בריאות של משרד ההגנה האמריקאי. חינמית.</p>`,
  ...
  },
  {
    ...
    color: 'bg-clay/10 text-clay',
    iconBg: 'bg-clay/15',
    content_he: `<p>מדיטציה מודרכת ושינה. חלקית חינמית - תקופת ניסיון ותכנים בסיסיים חינם, שאר התוכן בתשלום מנוי.</p>`,
  ...
  },
  {
    ...
    color: 'bg-clay/10 text-clay',
    iconBg: 'bg-clay/15',
    content_he: `<p>צ׳אטבוט בינה מלאכותית לתמיכה נפשית מבוסס CBT ו-DBT. השיחה הבסיסית עם הצ׳אטבוט חינמית, תכנים מורחבים וליווי אנושי בתשלום.</p>`,
