...
export const STATIC_TOOLS = [
  ...
  },
  {
    ...
    iconBg: 'bg-clay/15',
    content_he: `<ul><li><strong>Breathe2Relax</strong> - אפליקציה לתרגילי נשימה סרעפתית, פותחה על ידי גורמי בריאות של משרד ההגנה האמריקאי</li><li><strong>Calm / Headspace</strong> - מדיטציה מודרכת ושינה, חלקית חינמיות (תקופת ניסיון ותכנים בסיסיים חינם, שאר התוכן בתשלום מנוי)</li><li><strong>Wysa</strong> - צ׳אטבוט בינה מלאכותית לתמיכה נפשית מבוסס CBT ו-DBT; השיחה הבסיסית עם הצ׳אטבוט חינמית, תכנים מורחבים וליווי אנושי בתשלום</li></ul>`,
  },
  {
    ...
    iconBg: 'bg-sage/15',
    content_he: `<p><strong>Breath-Body-Mind (BBM)</strong> היא סדנת נשימות המשלבת תרגולי נשימה, תנועה ומדיטציה, המסייעים להפחתת מתח, שיפור ויסות רגשי וחיזוק תחושת רוגע וביטחון.</p>`,
  },
  {
    category: 'complementary',
    icon: 'Moon',
    ...
    color: 'bg-sage/10 text-sage',
    iconBg: 'bg-sage/15',
    content_he: `<p><strong>יוגה נידרה</strong> היא תרגול מונחה של הרפיה עמוקה, המדמה מצב שבין ערות לשינה. מטרתו לסייע בשיפור השינה, הפחתת חרדה וחיזוק תחושת היציבות הפנימית. ניתן לתרגל אותה עצמאית, בעזרת הקלטה מוקלטת.</p>`,
  },
];
